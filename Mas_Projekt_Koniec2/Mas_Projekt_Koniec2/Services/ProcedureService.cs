...
namespace Mas_Final_Project.Services
{
    internal class ProcedureService
    {
        ...
        public ObservableCollection<Procedure> GetProcedures() => new ObservableCollection<Procedure>(
                _context.Procedure
        ...
        public ObservableCollection<Procedure> GetProcedures(Doctor doctorId) => new ObservableCollection<Procedure>(
                _context.Procedure
        ...
        public ObservableCollection<Procedure> GetProceduresByName(string procedureName) => new ObservableCollection<Procedure>(
                _context.Procedure
