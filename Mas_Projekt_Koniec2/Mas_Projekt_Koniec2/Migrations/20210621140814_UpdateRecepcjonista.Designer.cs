...
namespace Mas_Projekt_Koniec2.Migrations
{
    ...
    [Migration("20210621140814_UpdateRecepcjonista")]
    partial class UpdateRecepcjonista
    {
            ...
            modelBuilder.Entity("Mas_Projekt_Koniec2.Models.Recepcjonista", b =>
                {
                    ...
                    b.Property<string>("JezykDodatkowy")
                        .IsRequired()
                        .HasMaxLength(25)
                        .HasColumnType("nvarchar(25)");
            ...
            modelBuilder.Entity("Mas_Projekt_Koniec2.Models.Salowy", b =>
                {
                    ...
                    b.Property<bool>("CzyPelniFunkcjePomocnicza")
                        .HasColumnType("bit");
